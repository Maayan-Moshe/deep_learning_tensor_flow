...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec 28 17:28:47 2017
...
STATE_PARAMS = {'state_folder': r'C:\Users\mmoshe\Documents\teeth_segmentation\hmap_data\saved_models\hmap_multi_scale',
...
DATA_PATH = '/media/sf_DeepLearningAlgIsrael/Maayan_Moshe/image_4D_reconstruction/20171224141532/predicted_z.npy'
...
class PredictedHeightMapPrinter:
    ...
    def __init__(self, state_params, graph_params):
        from image_4D_reconstruction.trivial_3x3_graph_builder import prepare_graph
...
class PredictedTensorPrinter:
    ...
    def __init__(self, state_params, graph_params):
        from height_map_reconstruction.multiscale_graph_builder import prepare_graph
...
if __name__ == '__main__':
    ...
    out_path = r'C:\Users\mmoshe\Documents\teeth_segmentation\hmap_data\results\real_dat_18_Mar_2018_14_31.npy'
